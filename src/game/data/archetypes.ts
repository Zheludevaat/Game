...
export const ARCHETYPES: ArchetypeDef[] = [
  {
    ...
    description: 'Balanced spellcaster with reliable mana, piercing control, and flexible range.',
  ...
  },
  {
    ...
    description: 'Slow, durable wanderer with high health, armor, and heavy melee pressure.',
  ...
  },
  {
    ...
    description: 'Fast, fragile astral striker with quick dashes, luck, and strong mana recovery.',
